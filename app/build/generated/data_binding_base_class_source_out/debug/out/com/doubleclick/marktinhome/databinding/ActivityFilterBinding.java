...
public final class ActivityFilterBinding implements ViewBinding {
  ...
  private ActivityFilterBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView FilterRecycler) {
    this.rootView = rootView;
    this.FilterRecycler = FilterRecycler;
  }
  ...
  public static ActivityFilterBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.FilterRecycler;
      RecyclerView FilterRecycler = ViewBindings.findChildViewById(rootView, id);
      if (FilterRecycler == null) {
        break missingId;
      }

      return new ActivityFilterBinding((ConstraintLayout) rootView, FilterRecycler);
    }
