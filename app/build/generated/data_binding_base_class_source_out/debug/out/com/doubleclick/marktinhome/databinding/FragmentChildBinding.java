...
public final class FragmentChildBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentChildBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentChildBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_child, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentChildBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.ChildRecycler;
      RecyclerView ChildRecycler = ViewBindings.findChildViewById(rootView, id);
