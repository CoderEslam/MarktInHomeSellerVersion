...
public final class FragmentViewmoreBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView ViewMoreRecyclerView;

  private FragmentViewmoreBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView ViewMoreRecyclerView) {
    this.rootView = rootView;
    this.ViewMoreRecyclerView = ViewMoreRecyclerView;
  }
  ...
  public static FragmentViewmoreBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.ViewMoreRecyclerView;
      RecyclerView ViewMoreRecyclerView = ViewBindings.findChildViewById(rootView, id);
      if (ViewMoreRecyclerView == null) {
        break missingId;
      }

      return new FragmentViewmoreBinding((ConstraintLayout) rootView, ViewMoreRecyclerView);
    }
