...
public final class LayoutProductBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutProductBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView,
  ...
  @NonNull
  public static LayoutProductBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutProductBinding((ConstraintLayout) rootView, cardView, description,
